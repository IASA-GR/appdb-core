...
{
    return do_http_request($url, 'GET', $data, $optional_headers);
}

function do_post_request($url, $data, $optional_headers = null)
{
    return do_http_request($url, 'POST', $data, $optional_headers);
}

function do_http_request($url, $method, $data, $optional_headers = null)
{
