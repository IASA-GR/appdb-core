...
?>
<?php
class Default_Model_DisciplineInfoEntryBase
{
	protected $_mapper;
	protected $_id;
	...
	public function __set($name,$value)
	{
		...
		if (('mapper' == $name) || !method_exists($this, $method)) {
			throw new Exception("Invalid DisciplineInfoEntry property: '$name'");
		}
		if ( is_string($value) ) {
	...
	public function getMapper()
	{
		if (null === $this->_mapper) {
			$this->setMapper(new Default_Model_DisciplineInfoMapper());
		}
		return $this->_mapper;
	}
