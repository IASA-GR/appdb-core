...
class Default_Model_HarvestProjectContactPersonsBase {
	protected $_items;
	protected $_mapper;
	protected $_filter;
	protected $_format;
	...
	public function __construct($filter = null)
	{
		$this->_items = null;
		if ( $filter === null ) {
			$this->_filter = new Default_Model_HarvestProjectContactPersonsFilter();
		} else {
			$this->_filter = $filter;
		}
	}
	...
	public function __set($name,$value)
	{
		...
		if (('mapper' == $name) || !method_exists($this, $method)) {
				throw new Exception("Invalid HarvestProjectContactPersons property: '$name'");
		}
		$this->$method($value);
	}
	...
	{
		$XML = "<HarvestProjectContactPersons>
";
		foreach ($this->_items as $item) {
