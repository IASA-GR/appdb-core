...
class Default_Model_HashFuncsMapperBase
{
	protected $_dbTable;
	...
	public function getDbTable()
	{
		if (null === $this->_dbTable) {
			$this->setDbTable('Default_Model_DbTable_HashFuncs');
		}
		return $this->_dbTable;
	}

	public function save(Default_Model_HashFunc $value)
	{
		global $application;
		$data = array();
	...
	public function delete(Default_Model_HashFunc $value)
	{
		$q1 = '';
		$q2 = '';
		$s=$this->getDbTable()->getAdapter()->quoteInto($q1,$q2);
	...
	public function find($id, Default_Model_HashFuncs &$value)
	{
	...
	public function fetchAll($filter = null, $format = '')
	{
		...
		foreach ($resultSet as $row) {
			$entry = new Default_Model_HashFunc();
