...
class Default_Model_AccountTypesMapperBase
{
	protected $_dbTable;
	...
	public function getDbTable()
	{
		if (null === $this->_dbTable) {
			$this->setDbTable('Default_Model_DbTable_AccountTypes');
		}
		return $this->_dbTable;
	}

	public function save(Default_Model_AccountType $value)
	{
		global $application;
		$data = array();
	...
	public function delete(Default_Model_AccountType $value)
	{
		$q1 = '';
		$q2 = '';
		$s=$this->getDbTable()->getAdapter()->quoteInto($q1,$q2);
	...
	public function find($id, Default_Model_AccountTypes &$value)
	{
	...
	public function fetchAll($filter = null, $format = '')
	{
		...
		foreach ($resultSet as $row) {
			$entry = new Default_Model_AccountType();
