...
class Default_Model_EntityGUIDsMapperBase
{
	protected $_dbTable;
	...
	public function getDbTable()
	{
		if (null === $this->_dbTable) {
			$this->setDbTable('Default_Model_DbTable_EntityGUIDs');
		}
		return $this->_dbTable;
	}

	public function save(Default_Model_EntityGUID $value)
	{
		global $application;
		$data = array();
		if ( ! isnull($value->getEntityType()) ) $data['entitytype'] = $value->getEntityType();
	...
	public function delete(Default_Model_EntityGUID $value)
	{
		$q1 = '';
		$q2 = '';
		$s=$this->getDbTable()->getAdapter()->quoteInto($q1,$q2);
	...
	{
		$entry->setEntityType($row->entitytype);
		$entry->setGuID($row->guid);
	}

	public function find($id, Default_Model_EntityGUIDs &$value)
	{
	...
	public function fetchAll($filter = null, $format = '')
	{
		...
		foreach ($resultSet as $row) {
			$entry = new Default_Model_EntityGUID();
