...
class Default_Model_AppCountriesMapperBase
{
	protected $_dbTable;
	...
	public function getDbTable()
	{
		if (null === $this->_dbTable) {
			$this->setDbTable('Default_Model_DbTable_AppCountries');
		}
		return $this->_dbTable;
	}

	public function save(Default_Model_AppCountry $value)
	{
		global $application;
		$data = array();
		...
		if ( ! isnull($value->getInherited()) ) $data['inherited'] = $this->pgBool($value->getInherited());
	...
	public function delete(Default_Model_AppCountry $value)
	{
		$q1 = '';
		$q2 = '';
		$s=$this->getDbTable()->getAdapter()->quoteInto($q1,$q2);
	...
	public function populate(&$entry,$row)
	{
		...
		$entry->setInherited($row->inherited);
	}

	public function find($id, Default_Model_AppCountries &$value)
	{
	...
	public function fetchAll($filter = null, $format = '')
	{
		...
		foreach ($resultSet as $row) {
			$entry = new Default_Model_AppCountry();
