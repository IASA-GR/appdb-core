...
class Default_Model_IntAuthorsMapperBase
{
	protected $_dbTable;
	...
	public function getDbTable()
	{
		if (null === $this->_dbTable) {
			$this->setDbTable('Default_Model_DbTable_IntAuthors');
		}
		return $this->_dbTable;
	}

	public function save(Default_Model_IntAuthor $value)
	{
		global $application;
		$data = array();
	...
	public function delete(Default_Model_IntAuthor $value)
	{
		$q1 = 'id = ?';
		$q2 = $value->id;
		$s=$this->getDbTable()->getAdapter()->quoteInto($q1,$q2);
	...
	public function find($id, Default_Model_IntAuthors &$value)
	{
