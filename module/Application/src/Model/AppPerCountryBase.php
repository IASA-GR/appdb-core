...
?>
<?php
class Default_Model_AppPerCountryBase
{
	protected $_mapper;
	protected $_id;
	protected $_name;
	...
	public function __set($name,$value)
	{
		...
		if (('mapper' == $name) || !method_exists($this, $method)) {
			throw new Exception("Invalid AppPerCountry property: '$name'");
		}
		if ( is_string($value) ) {
	...
	public function getMapper()
	{
		if (null === $this->_mapper) {
			$this->setMapper(new Default_Model_AppPerCountriesMapper());
		}
		return $this->_mapper;
	}
	...
	public function toXML($recursive=false)
	{
		...
		if ($this->_sum !== null) $XML .= "<sum>".$this->_sum."</sum>\n";
		$XML .= "</AppPerCountry>\n";
		return $XML;
	}
}
