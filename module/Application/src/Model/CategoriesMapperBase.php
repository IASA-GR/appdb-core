...
class Default_Model_CategoriesMapperBase
{
	protected $_dbTable;
	...
	public function save(Default_Model_Category $value)
	{
		global $application;
		$data = array();
	...
	public function delete(Default_Model_Category $value)
	{
		$q1 = 'id = ?';
		$q2 = $value->id;
		$s=$this->getDbTable()->getAdapter()->quoteInto($q1,$q2);
	...
	public function find($id, Default_Model_Categories &$value)
	{
