...
class Default_Model_AppContactOtherItemsMapperBase
{
	protected $_dbTable;
	...
	public function getDbTable()
	{
		if (null === $this->_dbTable) {
			$this->setDbTable('Default_Model_DbTable_AppContactOtherItems');
		}
	...
	public function delete(Default_Model_AppContactOtherItem $value)
	{
		$q1 = array('appid = ?', 'researcherid = ?', 'item = ?');
		$q2 = array($value->appid, $value->researcherid, $value->item);
		$s = array();
	...
	public function find($id, Default_Model_AppContactOtherItems &$value)
	{
	...
	{
		$select = $this->getDbTable()->select();
		$select->from($this->getDbTable(),array('COUNT(DISTINCT (appid, researcherid, item)) AS count'));
	...
	public function fetchAll($filter = null, $format = '')
	{
		...
		foreach ($resultSet as $row) {
			$entry = new Default_Model_AppContactOtherItem();
