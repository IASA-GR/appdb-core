...
class Default_Model_DomainsMapperBase
{
	protected $_dbTable;
	...
	public function getDbTable()
	{
		if (null === $this->_dbTable) {
			$this->setDbTable('Default_Model_DbTable_Domains');
		}
		return $this->_dbTable;
	}

	public function save(Default_Model_Domain $value)
	{
		global $application;
		$data = array();
	...
	public function delete(Default_Model_Domain $value)
	{
		$q1 = 'id = ?';
		$q2 = $value->id;
		$s=$this->getDbTable()->getAdapter()->quoteInto($q1,$q2);
	...
	public function find($id, Default_Model_Domains &$value)
	{
