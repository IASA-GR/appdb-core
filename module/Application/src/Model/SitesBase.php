...
class Default_Model_SitesBase {
	...
	public function __construct($filter = null)
	{
		$this->_items = null;
		if ( $filter === null ) {
			$this->_filter = new Default_Model_SitesFilter();
		} else {
			$this->_filter = $filter;
		}
	}
	...
	public function __set($name,$value)
	{
		...
		if (('mapper' == $name) || !method_exists($this, $method)) {
				throw new Exception("Invalid Sites property: '$name'");
		}
		$this->$method($value);
	}
	...
	public function refresh($format = '',$details = false)
	{
		$this->_items = $this->getMapper()->fetchAll($this->_filter, $format, $details);
		return $this;
	}
