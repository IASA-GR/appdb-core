...
class Default_Model_ActorGroupsMapperBase
{
	protected $_dbTable;
	...
	public function getDbTable()
	{
		if (null === $this->_dbTable) {
			$this->setDbTable('Default_Model_DbTable_ActorGroups');
		}
		return $this->_dbTable;
	}

	public function save(Default_Model_ActorGroup $value)
	{
		global $application;
		$data = array();
	...
	public function delete(Default_Model_ActorGroup $value)
	{
		$q1 = 'id = ?';
		$q2 = $value->id;
		$s=$this->getDbTable()->getAdapter()->quoteInto($q1,$q2);
	...
	public function find($id, Default_Model_ActorGroups &$value)
	{
	...
	public function fetchAll($filter = null, $format = '')
	{
		...
		foreach ($resultSet as $row) {
			$entry = new Default_Model_ActorGroup();
