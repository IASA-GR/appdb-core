...
class VOContactBase extends AROItem {
	public function __construct() {
		$this->_basename = 'VOContacts';
		$this->_baseitemname = 'VOContact';
		parent::__construct();
		...
		$this->_properties[] = new \Application\Model\AROProperty($this, 'role', 'role');
