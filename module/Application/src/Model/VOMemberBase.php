...
class VOMemberBase extends AROItem {
	public function __construct() {
		$this->_basename = 'VOMembers';
		$this->_baseitemname = 'VOMember';
		parent::__construct();
		...
		$this->_properties[] = new \Application\Model\AROProperty($this, 'member_since', 'memberSince');
	}
}
?>