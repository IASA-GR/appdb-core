...
class UserCredentialBase extends AROItem {
	public function __construct() {
		$this->_basename = 'UserCredentials';
		$this->_baseitemname = 'UserCredential';
		parent::__construct();
		...
		$this->_properties[] = new \Application\Model\AROProperty($this, 'sessionid', 'sessionID');
