...
class Default_Model_VOContactsMapperBase
{
	protected $_dbTable;
	...
	public function getDbTable()
	{
		if (null === $this->_dbTable) {
			$this->setDbTable('Default_Model_DbTable_VOContacts');
		}
	...
	public function save(Default_Model_VOContact $value)
	{
		...
		if ( ! isnull($value->getRole()) ) $data['role'] = $value->getRole();
	...
	public function delete(Default_Model_VOContact $value)
	{
		$q1 = '';
		$q2 = '';
		$s=$this->getDbTable()->getAdapter()->quoteInto($q1,$q2);
	...
	public function find($id, Default_Model_VOContacts &$value)
	{
	...
	public function fetchAll($filter = null, $format = '')
	{
		...
		foreach ($resultSet as $row) {
			$entry = new Default_Model_VOContact();
