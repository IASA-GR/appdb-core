...
class AppDelInfoBase extends AROItem {
	public function __construct() {
		$this->_basename = 'AppDelInfos';
		$this->_baseitemname = 'AppDelInfo';
		parent::__construct();
		...
		$this->_properties[] = new \Application\Model\AROProperty($this, 'deletedby', 'deleter', 'Researcher');
		$this->_properties[] = new \Application\Model\AROProperty($this, 'deletedon', 'deletedOn');
		$this->_properties[] = new \Application\Model\AROProperty($this, 'roleid', 'roleID');
		$this->_properties[] = new \Application\Model\AROProperty($this, 'roleid', 'positionType', 'PositionType');
	}
}
?>