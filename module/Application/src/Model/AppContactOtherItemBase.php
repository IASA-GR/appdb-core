...
?>
<?php
class Default_Model_AppContactOtherItemBase
{
	protected $_mapper;
	protected $_appID;
	...
	public function __set($name,$value)
	{
		...
		if (('mapper' == $name) || !method_exists($this, $method)) {
			throw new Exception("Invalid AppContactOtherItem property: '$name'");
		}
		if ( is_string($value) ) {
	...
	public function getMapper()
	{
		if (null === $this->_mapper) {
			$this->setMapper(new Default_Model_AppContactOtherItemsMapper());
		}
		return $this->_mapper;
	}
