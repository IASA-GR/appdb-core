...
class ContextBase extends AROItem {
	public function __construct() {
		$this->_basename = 'Contexts';
		$this->_baseitemname = 'Context';
		parent::__construct();
		$this->_properties[] = new \Application\Model\AROProperty($this, 'id', 'id');
		$this->_properties[] = new \Application\Model\AROProperty($this, 'appid', 'applicationID');
