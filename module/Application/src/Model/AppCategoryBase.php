...
class AppCategoryBase extends AROItem {
	public function __construct() {
		$this->_basename = 'AppCategories';
		$this->_baseitemname = 'AppCategory';
		parent::__construct();
		...
		$this->_properties[] = new \Application\Model\AROProperty($this, 'categoryid', 'category', 'Category');
