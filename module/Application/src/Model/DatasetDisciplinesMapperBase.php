...
class Default_Model_DatasetDisciplinesMapperBase
{
	protected $_dbTable;
	...
	public function getDbTable()
	{
		if (null === $this->_dbTable) {
			$this->setDbTable('Default_Model_DbTable_DatasetDisciplines');
		}
		return $this->_dbTable;
	}

	public function save(Default_Model_DatasetDiscipline $value)
	{
		global $application;
		$data = array();
	...
	public function delete(Default_Model_DatasetDiscipline $value)
	{
		$q1 = 'id = ?';
		$q2 = $value->id;
		$s=$this->getDbTable()->getAdapter()->quoteInto($q1,$q2);
	...
	{
		$entry->setId($row->id);
		$entry->setDatasetID($row->datasetid);
		$entry->setDisciplineID($row->disciplineid);
		$entry->setInherited($row->inherited);
	}

	public function find($id, Default_Model_DatasetDisciplines &$value)
	{
	...
	public function fetchAll($filter = null, $format = '')
	{
		...
		foreach ($resultSet as $row) {
			$entry = new Default_Model_DatasetDiscipline();
