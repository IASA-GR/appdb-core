...
class Default_Model_StatusesMapperBase
{
	protected $_dbTable;
	...
	public function getDbTable()
	{
		if (null === $this->_dbTable) {
			$this->setDbTable('Default_Model_DbTable_Statuses');
		}
		return $this->_dbTable;
	}

	public function save(Default_Model_Status $value)
	{
		global $application;
		$data = array();
	...
	public function delete(Default_Model_Status $value)
	{
		$q1 = 'id = ?';
		$q2 = $value->id;
		$s=$this->getDbTable()->getAdapter()->quoteInto($q1,$q2);
	...
	public function find($id, Default_Model_Statuses &$value)
	{
