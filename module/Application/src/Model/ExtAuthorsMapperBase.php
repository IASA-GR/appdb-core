...
class Default_Model_ExtAuthorsMapperBase
{
	protected $_dbTable;
	...
	public function getDbTable()
	{
		if (null === $this->_dbTable) {
			$this->setDbTable('Default_Model_DbTable_ExtAuthors');
		}
		return $this->_dbTable;
	}

	public function save(Default_Model_ExtAuthor $value)
	{
		global $application;
		$data = array();
		if ( ! isnull($value->getId()) ) $data['id'] = $value->getId();
		if ( ! isnull($value->getDocID()) ) $data['docid'] = $value->getDocID();
		if ( ! isnull($value->getAuthor()) ) $data['author'] = $value->getAuthor();
	...
	public function delete(Default_Model_ExtAuthor $value)
	{
		$q1 = 'id = ?';
		$q2 = $value->id;
		$s=$this->getDbTable()->getAdapter()->quoteInto($q1,$q2);
	...
	public function find($id, Default_Model_ExtAuthors &$value)
	{
	...
	public function fetchAll($filter = null, $format = '')
	{
		...
		foreach ($resultSet as $row) {
			$entry = new Default_Model_ExtAuthor();
