...
class Default_Model_AppReleaseCountMapperBase
{
	protected $_dbTable;
	...
	public function getDbTable()
	{
		if (null === $this->_dbTable) {
			$this->setDbTable('Default_Model_DbTable_AppReleaseCount');
		}
		return $this->_dbTable;
	}

	public function save(Default_Model_AppReleaseCount $value)
	{
		global $application;
		$data = array();
		if ( ! isnull($value->getAppID()) ) $data['appid'] = $value->getAppID();
		if ( ! isnull($value->getRelCount()) ) $data['relcount'] = $value->getRelCount();
	...
	public function delete(Default_Model_AppReleaseCountEntry $value)
	{
		$q1 = '';
		$q2 = '';
		$s=$this->getDbTable()->getAdapter()->quoteInto($q1,$q2);
	...
	public function populate(&$entry,$row)
	{
		...
		$entry->setRelCount($row->relcount);
	}

	public function find($id, Default_Model_AppReleaseCount &$value)
	{
	...
	public function fetchAll($filter = null, $format = '')
	{
		...
		foreach ($resultSet as $row) {
			$entry = new Default_Model_AppReleaseCountEntry();
