...
class Default_Model_TargetsMapperBase
{
	protected $_dbTable;
	...
	public function getDbTable()
	{
		if (null === $this->_dbTable) {
			$this->setDbTable('Default_Model_DbTable_Targets');
		}
		return $this->_dbTable;
	}

	public function save(Default_Model_Target $value)
	{
		global $application;
		$data = array();
		...
		if ( ! isnull($value->getHidden()) ) $data['hidden'] = $this->pgBool($value->getHidden());
	...
	public function delete(Default_Model_Target $value)
	{
		$q1 = '';
		$q2 = '';
		$s=$this->getDbTable()->getAdapter()->quoteInto($q1,$q2);
	...
	public function find($id, Default_Model_Targets &$value)
	{
	...
	public function fetchAll($filter = null, $format = '')
	{
		...
		foreach ($resultSet as $row) {
			$entry = new Default_Model_Target();
