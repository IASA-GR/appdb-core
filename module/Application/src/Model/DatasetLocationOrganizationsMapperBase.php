...
class Default_Model_DatasetLocationOrganizationsMapperBase
{
	protected $_dbTable;
	...
	public function getDbTable()
	{
		if (null === $this->_dbTable) {
			$this->setDbTable('Default_Model_DbTable_DatasetLocationOrganizations');
		}
		return $this->_dbTable;
	}

	public function save(Default_Model_DatasetLocationOrganization $value)
	{
		global $application;
		$data = array();
		if ( ! isnull($value->getId()) ) $data['id'] = $value->getId();
		if ( ! isnull($value->getDatasetLocationID()) ) $data['dataset_location_id'] = $value->getDatasetLocationID();
	...
	public function delete(Default_Model_DatasetLocationOrganization $value)
	{
		$q1 = 'id = ?';
		$q2 = $value->id;
		$s=$this->getDbTable()->getAdapter()->quoteInto($q1,$q2);
	...
	{
		$entry->setId($row->id);
		$entry->setDatasetLocationID($row->dataset_location_id);
		$entry->setOrganizationID($row->organizationid);
	}

	public function find($id, Default_Model_DatasetLocationOrganizations &$value)
	{
	...
	public function fetchAll($filter = null, $format = '')
	{
		...
		foreach ($resultSet as $row) {
			$entry = new Default_Model_DatasetLocationOrganization();
