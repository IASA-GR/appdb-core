...
?>
<?php
class Default_Model_CategoryBase
{
	protected $_mapper;
	protected $_id;
	protected $_name;
	...
	public function getParent()
	{
		if ( $this->_parent === null ) {
			...
			$Categories->filter->id->equals($this->getParentID());
			if ($Categories->count() > 0) $this->_parent = $Categories->items[0];
		}
		return $this->_parent;
	}
	...
	public function getMapper()
	{
		if (null === $this->_mapper) {
			$this->setMapper(new Default_Model_CategoriesMapper());
		}
		return $this->_mapper;
	}
