...
class Default_Model_AppAutoCountriesMapperBase
{
	protected $_dbTable;
	...
	public function getDbTable()
	{
		if (null === $this->_dbTable) {
			$this->setDbTable('Default_Model_DbTable_AppAutoCountries');
		}
		return $this->_dbTable;
	}

	public function save(Default_Model_AppAutoCountry $value)
	{
		global $application;
		$data = array();
	...
	public function delete(Default_Model_AppAutoCountry $value)
	{
		$q1 = '';
		$q2 = '';
		$s=$this->getDbTable()->getAdapter()->quoteInto($q1,$q2);
	...
	public function find($id, Default_Model_AppAutoCountries &$value)
	{
	...
	public function fetchAll($filter = null, $format = '')
	{
		...
		foreach ($resultSet as $row) {
			$entry = new Default_Model_AppAutoCountry();
