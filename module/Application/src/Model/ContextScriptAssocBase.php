...
class ContextScriptAssocBase extends AROItem {
	public function __construct() {
		$this->_basename = 'ContextScriptAssocs';
		$this->_baseitemname = 'ContextScriptAssoc';
		parent::__construct();
		$this->_properties[] = new \Application\Model\AROProperty($this, 'id', 'id');
		$this->_properties[] = new \Application\Model\AROProperty($this, 'contextid', 'contextID');
		$this->_properties[] = new \Application\Model\AROProperty($this, 'scriptid', 'scriptID');
