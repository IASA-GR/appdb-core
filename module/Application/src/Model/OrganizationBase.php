...
class OrganizationBase extends AROItem {
	public function __construct() {
		$this->_basename = 'Organizations';
		$this->_baseitemname = 'Organization';
		parent::__construct();
		...
		$this->_properties[] = new \Application\Model\AROProperty($this, 'deletedby', 'deletedByID');
