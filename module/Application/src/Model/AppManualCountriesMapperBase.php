...
class Default_Model_AppManualCountriesMapperBase
{
	protected $_dbTable;
	...
	public function getDbTable()
	{
		if (null === $this->_dbTable) {
			$this->setDbTable('Default_Model_DbTable_AppManualCountries');
		}
		return $this->_dbTable;
	}

	public function save(Default_Model_AppManualCountry $value)
	{
		global $application;
		$data = array();
		...
		$q1 = array('appid = ?', 'countryid = ?');
		$q2 = array($value->appid, $value->countryid);
	...
	public function delete(Default_Model_AppManualCountry $value)
	{
		$q1 = array('appid = ?', 'countryid = ?');
		$q2 = array($value->appid, $value->countryid);
		$s = array();
	...
	public function find($id, Default_Model_AppManualCountries &$value)
	{
	...
	{
		$select = $this->getDbTable()->select();
		$select->from($this->getDbTable(),array('COUNT(DISTINCT (appid, countryid)) AS count'));
	...
	public function fetchAll($filter = null, $format = '')
	{
		...
		foreach ($resultSet as $row) {
			$entry = new Default_Model_AppManualCountry();
