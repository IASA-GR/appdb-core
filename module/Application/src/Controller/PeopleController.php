...
class PeopleController extends AbstractActionController
{
    ...
    public function getimageAction()
	{
		...
		if ( ($this->_getParam("id") == "0") || ($this->_getParam("id") == '')) {
			...
			if ( file_exists($_SERVER['APPLICATION_PATH'] . "/../cache/ppl-image-".$this->_getParam("id").".png") ) {
                $image = file_get_contents($_SERVER['APPLICATION_PATH'] . "/../cache/ppl-image-".$this->_getParam("id").".png");
			} else {
				$ppl = new Default_Model_Researchers();
