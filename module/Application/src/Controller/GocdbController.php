...
//require_once($_SERVER['APPLICATION_PATH'] . "/../library/argo.php");
...
class GocdbController extends AbstractActionController
{
...
//	}
	...
	private function syncSiteContacts() {
		...
		try {
			...
			@curl_close($ch);
			@exec("rm ". $_SERVER['APPLICATION_PATH'] . "/../cache/site_contacts.xml.old");
			@exec("cp " . $_SERVER['APPLICATION_PATH'] . "/../cache/site_contacts.xml ". $_SERVER['APPLICATION_PATH'] . "/../cache/site_contacts.xml.old");
			$f = fopen($_SERVER['APPLICATION_PATH'] . "/../cache/site_contacts.xml","w");
			fwrite($f, $xml);
			fclose($f);
			if (@md5_file($_SERVER['APPLICATION_PATH'] . "/../cache/site_contacts.xml") !== @md5_file($_SERVER['APPLICATION_PATH'] . "/../cache/site_contacts.xml.old")) {
				$xml = new SimpleXMLElement(file_get_contents($_SERVER['APPLICATION_PATH'] . "/../cache/site_contacts.xml"));
...
//			@curl_close($ch);
//
//			$fff = fopen($_SERVER['APPLICATION_PATH'] . "/../cache/downtimes.xml","w");
//			fwrite($fff, $xml);
//			fclose($fff);
//
//			$xml = new SimpleXMLElement($xml);
...
//			}
//			@curl_close($ch);
//			@exec("rm ". $_SERVER['APPLICATION_PATH'] . "/../cache/va_providers.xml.old");
//			@exec("cp " . $_SERVER['APPLICATION_PATH'] . "/../cache/va_providers.xml ". $_SERVER['APPLICATION_PATH'] . "/../cache/va_providers.xml.old");
//			$f = fopen($_SERVER['APPLICATION_PATH'] . "/../cache/va_providers.xml","w");
//			fwrite($f, $xml);
//			fclose($f);
//			if (@md5_file($_SERVER['APPLICATION_PATH'] . "/../cache/va_providers.xml") !== @md5_file($_SERVER['APPLICATION_PATH'] . "/../cache/va_providers.xml.old")) {	
//				$xml = new SimpleXMLElement(file_get_contents($_SERVER['APPLICATION_PATH'] . "/../cache/va_providers.xml"));
