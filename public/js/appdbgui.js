...
appdb.utils.DataWatcher.Registry.set("vappliance",{items :[
	 ...
	 {selector : ".workingversion > .vappliance-version .property.vaversion-vmilist > .property.vaversion-vmis > ul > li > .property.vaversion-vmi .property.vaversion-vmiversionlist > ul > li > .property.vaversion-vmiversion .property.vmiversion-mincores > .values > .dijitTextBox", type: "imagemincores", name: "Image Minimum Number of Cores"},
	 {selector : ".workingversion > .vappliance-version .property.vaversion-vmilist > .property.vaversion-vmis > ul > li > .property.vaversion-vmi .property.vaversion-vmiversionlist > ul > li > .property.vaversion-vmiversion .property.vmiversion-recomcores > .value > .dijitTextBox", type: "imagereccores", name: "Image Recommended Number of Cores"},
	 {selector : ".workingversion > .vappliance-version .property.vaversion-vmilist > .property.vaversion-vmis > ul > li > .property.vaversion-vmi .property.vaversion-vmiversionlist > ul > li > .property.vaversion-vmiversion .property.vmiversion-minram > .value > .dijitTextBox", type: "imageminram", name: "Image Minimum RAM"},
	 {selector : ".workingversion > .vappliance-version .property.vaversion-vmilist > .property.vaversion-vmis > ul > li > .property.vaversion-vmi .property.vaversion-vmiversionlist > ul > li > .property.vaversion-vmiversion .property.vmiversion-recomram > .value > .dijitTextBox", type: "imagerecram", name: "Image Recommended RAM"},
