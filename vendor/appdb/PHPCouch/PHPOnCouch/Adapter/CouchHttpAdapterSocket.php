...
require_once "CouchHttpAdapterCurl.php";
require_once "AbstractCouchHttpAdapter.php";
require_once "CouchHttpAdapterInterface.php";
#require_once "CouchHttpAdapterSocket.php";
