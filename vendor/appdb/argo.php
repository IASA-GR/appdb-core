...
abstract class Argo {
	...
	public function __construct($serviceType = "eu.egi.cloud.vm-management.occi", $reportType = "Critical") {
		...
		curl_setopt($this->_ch, CURLOPT_SSLCERT, $_SERVER['APPLICATION_PATH'] . '/../bin/sec/usercert.pem');
		curl_setopt($this->_ch, CURLOPT_SSLKEY, $_SERVER['APPLICATION_PATH'] . '/../bin/sec/userkey.pem');
