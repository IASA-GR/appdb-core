...
//	public function get() {
//		if ( parent::get() !== false ) {
//			$res1 = new \Application\Model\Middlewares();
//			$res2 = new \Application\Model\AppMiddlewares();
//			$res1->refresh("xml");
//			$res2->refresh("xml");
...
//	}
	...
	protected function getModel() {
		return new \Application\Model\Middlewares();
	}
}
...
class RestStatusList extends RestROResourceList {
     ...
     */
	protected function getModel() {
		return new Application\Model\Statuses();
	}
}
...
class RestRoleList extends RestROResourceList {
     ...
     */
	protected function getModel() {
		$res = new \Application\Model\PositionTypes();
...
class RestContactTypeList extends RestROResourceList {
     ...
     */
	protected function getModel() {
		return new \Application\Model\ContactTypes();
	}
}
...
class RestCategoryList extends RestROResourceList {
     ...
     */
	protected function getModel() {
		$res = new \Application\Model\Categories();
		return $res;
	}
}
...
class RestDisciplineList extends RestROResourceList {
     ...
     */
	protected function getModel() {
		$res = new \Application\Model\Disciplines();
...
class RestRegionalList extends RestROResourceList {
    ...
    protected function _list() {
   		$ret = array();
        $res1 = new \Application\Model\Countries();
        $res2 = new \Application\Model\Regions();
        $res3 = new \Application\Model\NGIs();
        $res1->refresh();
        $res2->refresh();
        $res3->refresh();
...
class RestDisseminationList extends RestResourceList {
     ...
     */
	protected function getModel() {
		$res = new \Application\Model\Dissemination();
...
class RestAppDBResourceList extends RestROResourceList {
	...
	public function get() {
		if ( parent::get() !== false ) {
			$s = file_get_contents($_SERVER['APPLICATION_PATH'] . "/apiroutes.xml");
...
class RestLangList extends RestROResourceList {
	...
	public function getModel() {
		return new \Application\Model\ProgLangs();
	}
}
...
class RestOSList extends RestROResourceList {
	...
	public function get() {
		if ( parent::get() !== false ) {
			$res2 = new \Application\Model\OSes();
			$res1 = new \Application\Model\OSFamilies();
			$xml = array();
...
//	public function getModel() {
//		return new \Application\Model\OSes();
//	}
}
...
class RestLicenseList extends RestROResourceList {
	...
	public function getModel() {
		return new \Application\Model\Licenses();
	}
}
...
class RestArchList extends RestROResourceList {
	...
	public function getModel() {
		return new \Application\Model\Archs();
	}
}
...
class RestHVList extends RestROResourceList {
	...
	public function getModel() {
		return new \Application\Model\Hypervisors();
	}
}
...
class RestVMIFmtList extends RestROResourceList {
	...
	public function getModel() {
		return new \Application\Model\VMIformats();
	}
}
...
class RestVAProvidersList extends RestROResourceList {
	...
	public function getModel() {
		return new \Application\Model\VaProviders();
	}
}
class RestVAProviderItem extends RestROResourceItem {
    ...
    protected function init() {
		$this->_logged = false;
		$this->_resParent = new \Application\Model\VaProviders();
...
class RestContextScriptFormatList extends RestROResourceList{
	...
	public function get(){
		if ( parent::get() !== false ) {
			$res = new \Application\Model\ContextFormats();
			$xml = array();
	...
	public function getModel() {
		return new \Application\Model\ContextFormats();
	}
}
