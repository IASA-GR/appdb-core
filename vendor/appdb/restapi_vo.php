...
class RestVOMemberList extends RestROSelfAuthResourceList {
	...
	public function getModel() {
		$res = new \Application\Model\VOMembers();
		...
		$f = new \Application\Model\VOMembersFilter();
...
class RestVOContactList extends RestROResourceList {
	...
	public function getModel() {
		$res = new \Application\Model\VOContacts();
		...
		$f = new \Application\Model\VOContactsFilter();
   ...
   /**
	...
	public function get($extraFilter = null) {
		if ( parent::get() !== false ) {
			...
			$mapper = new \Application\Model\VOsMapper();
