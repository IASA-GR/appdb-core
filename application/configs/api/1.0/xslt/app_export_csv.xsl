...
xmlsns:discipline="http://appdb.egi.eu/api/1.0/discipline">
	<xsl:output method="text"/>
	<xsl:strip-space elements="*"/>
    
	<xsl:template match="//applications">
		<xsl:text>"Name","Description","Abstract","Date Added","Added By","Owner","Status","Middlewares","VOs","Disciplines","Subdisciplines","Countries","Category","URLs","Researchers"&#x0A;</xsl:text>
		<xsl:apply-templates />
	</xsl:template>
