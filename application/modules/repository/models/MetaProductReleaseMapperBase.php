...
class Repository_Model_MetaProductReleaseMapperBase
{
	protected $_dbTable;
	...
	public function getDbTable()
	{
		if (null === $this->_dbTable) {
			$this->setDbTable('Repository_Model_DbTable_MetaProductRelease');
		}
	...
	public function save(Repository_Model_MetaProductRelease $value)
	{
		...
		if ( ! isnull($value->getAppDBId()) ) $data['appDBId'] = $value->getAppDBId();
		...
		if ( ! isnull($value->getTechnicalContact()) ) $data['technicalContact'] = $value->getTechnicalContact();
		if ( ! isnull($value->getISODate()) ) $data['ISODate'] = $value->getISODate();
		if ( ! isnull($value->getIncremental()) ) $data['incremental'] = $this->mysqlBool($value->getIncremental());
	...
	public function populate(&$entry,$row)
	{
		...
		$entry->setTechnicalContact($row->technicalContact);
	...
	public function find($id, Repository_Model_MetaProductRelease &$value)
	{
