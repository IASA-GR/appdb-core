...
class Repository_Model_ConfigMapperBase
{
	protected $_dbTable;
	...
	public function getDbTable()
	{
		if (null === $this->_dbTable) {
			$this->setDbTable('Repository_Model_DbTable_Config');
		}
		return $this->_dbTable;
	}

	public function save(Repository_Model_Config $value)
	{
		global $application;
		$data = array();
	...
	public function delete(Repository_Model_ConfigEntry $value)
	{
		$q1 = 'id = ?';
		$q2 = $value->id;
		$s=$this->getDbTable()->getAdapter()->quoteInto($q1,$q2);
	...
	public function find($id, Repository_Model_Config &$value)
	{
	...
	public function fetchAll($filter = null, $format = '')
	{
		...
		foreach ($resultSet as $row) {
			$entry = new Repository_Model_ConfigEntry();
