...
class Repository_Model_CommRepoAllowedOsDmethodCombinationsBase {
	protected $_items;
	protected $_mapper;
	protected $_filter;
	protected $_format;
	...
	public function __construct($filter = null)
	{
		$this->_items = null;
		if ( $filter === null ) {
			$this->_filter = new Repository_Model_CommRepoAllowedOsDmethodCombinationsFilter();
		} else {
			$this->_filter = $filter;
		}
	}
	...
	public function __set($name,$value)
	{
		...
		if (('mapper' == $name) || !method_exists($this, $method)) {
				throw new Exception("Invalid CommRepoAllowedOsDmethodCombinations property: '$name'");
		}
		$this->$method($value);
	}
	...
	{
		$XML = "<CommRepoAllowedOsDmethodCombinations>
";
		foreach ($this->_items as $item) {
