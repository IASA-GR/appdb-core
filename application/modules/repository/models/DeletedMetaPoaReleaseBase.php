<?php
class Repository_Model_DeletedMetaPoaReleaseBase
{
	protected $_mapper;
	...
	public function __set($name,$value)
	{
		...
		if (('mapper' == $name) || !method_exists($this, $method)) {
			throw new Exception("Invalid DeletedMetaPoaRelease property: '$name'");
		}
		if ( is_string($value) ) {
	...
	public function getMapper()
	{
		if (null === $this->_mapper) {
			$this->setMapper(new Repository_Model_DeletedMetaPoaReleaseMapper());
		}
		return $this->_mapper;
	}
