<?php
class Repository_Model_DeletedMetaProductRepoAreaBase
{
	protected $_mapper;
	...
	public function __set($name,$value)
	{
		...
		if (('mapper' == $name) || !method_exists($this, $method)) {
			throw new Exception("Invalid DeletedMetaProductRepoArea property: '$name'");
		}
		if ( is_string($value) ) {
	...
	public function getMapper()
	{
		if (null === $this->_mapper) {
			$this->setMapper(new Repository_Model_DeletedMetaProductRepoAreasMapper());
		}
		return $this->_mapper;
	}
	...
	{
		$XML = "<DeletedMetaProductRepoArea>\n";
