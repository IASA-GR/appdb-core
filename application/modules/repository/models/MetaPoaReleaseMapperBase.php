...
class Repository_Model_MetaPoaReleaseMapperBase
{
	protected $_dbTable;

	private function mysqlBool($v) { if ($v) return "1"; else return "0"; }
	...
	public function getDbTable()
	{
		if (null === $this->_dbTable) {
			$this->setDbTable('Repository_Model_DbTable_MetaPoaRelease');
		}
	...
	public function find($id, Repository_Model_MetaPoaRelease &$value)
	{
