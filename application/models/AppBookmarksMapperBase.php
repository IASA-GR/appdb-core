...
class Default_Model_AppBookmarksMapperBase
{
	protected $_dbTable;
	...
	public function getDbTable()
	{
		if (null === $this->_dbTable) {
			$this->setDbTable('Default_Model_DbTable_AppBookmarks');
		}
	...
	public function delete(Default_Model_AppBookmark $value)
	{
		$q1 = array('appid = ?', 'researcherid = ?');
		$q2 = array($value->appid, $value->researcherid);
		$s = array();
	...
	public function find($id, Default_Model_AppBookmarks &$value)
	{
	...
	public function fetchAll($filter = null, $format = '')
	{
		...
		foreach ($resultSet as $row) {
			$entry = new Default_Model_AppBookmark();
