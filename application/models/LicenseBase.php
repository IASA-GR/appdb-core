...
?>
<?php
class Default_Model_LicenseBase
{
	protected $_mapper;
	protected $_id;
	protected $_name;
	...
	public function __set($name,$value)
	{
		...
		if (('mapper' == $name) || !method_exists($this, $method)) {
			throw new Exception("Invalid License property: '$name'");
		}
		if ( is_string($value) ) {
	...
	public function getMapper()
	{
		if (null === $this->_mapper) {
			$this->setMapper(new Default_Model_LicensesMapper());
		}
		return $this->_mapper;
	}
	...
	public function toXML($recursive=false)
	{
		...
		if ($this->_group !== null) $XML .= "<group>".recode_string("utf8..xml",$this->_group)."</group>\n";
		$XML .= "</License>\n";
		return $XML;
	}
}
