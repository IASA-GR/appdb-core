...
class Default_Model_LicensesMapperBase
{
	protected $_dbTable;
	...
	public function getDbTable()
	{
		if (null === $this->_dbTable) {
			$this->setDbTable('Default_Model_DbTable_Licenses');
		}
		return $this->_dbTable;
	}

	public function save(Default_Model_Licens $value)
	{
		global $application;
		$data = array();
		...
		if ( ! isnull($value->getGroup()) ) $data['group'] = $value->getGroup();
	...
	public function delete(Default_Model_License $value)
	{
		$q1 = 'id = ?';
		$q2 = $value->id;
		$s=$this->getDbTable()->getAdapter()->quoteInto($q1,$q2);
	...
	public function populate(&$entry,$row)
	{
		...
		$entry->setGroup($row->group);
	}

	public function find($id, Default_Model_Licenses &$value)
	{
	...
	public function fetchAll($filter = null, $format = '')
	{
		...
		foreach ($resultSet as $row) {
			$entry = new Default_Model_License();
