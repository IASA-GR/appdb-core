...
class Default_Model_NGIsMapperBase
{
	protected $_dbTable;
	...
	public function getDbTable()
	{
		if (null === $this->_dbTable) {
			$this->setDbTable('Default_Model_DbTable_NGIs');
		}
	...
	public function save(Default_Model_NGI $value)
	{
		...
		if ( ! isnull($value->getEuropean()) ) $data['european'] = $this->pgBool($value->getEuropean());
	...
	public function delete(Default_Model_NGI $value)
	{
		$q1 = 'id = ?';
		$q2 = $value->id;
		$s=$this->getDbTable()->getAdapter()->quoteInto($q1,$q2);
	...
	public function populate(&$entry,$row)
	{
		...
		$entry->setEuropean($row->european);
		$entry->setLogo($row->logo);
	}

	public function find($id, Default_Model_NGIs &$value)
	{
