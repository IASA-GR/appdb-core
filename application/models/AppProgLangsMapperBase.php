...
class Default_Model_AppProgLangsMapperBase
{
	protected $_dbTable;
	...
	public function getDbTable()
	{
		if (null === $this->_dbTable) {
			$this->setDbTable('Default_Model_DbTable_AppProgLangs');
		}
		return $this->_dbTable;
	}

	public function save(Default_Model_AppProgLang $value)
	{
		global $application;
		$data = array();
		...
		$q1 = array('appid = ?', 'proglangid = ?');
		$q2 = array($value->appid, $value->proglangid);
	...
	public function delete(Default_Model_AppProgLang $value)
	{
		$q1 = array('appid = ?', 'proglangid = ?');
		$q2 = array($value->appid, $value->proglangid);
		$s = array();
	...
	public function find($id, Default_Model_AppProgLangs &$value)
	{
	...
	{
		$select = $this->getDbTable()->select();
		$select->from($this->getDbTable(),array('COUNT(DISTINCT (appid, proglangid)) AS count'));
	...
	public function fetchAll($filter = null, $format = '')
	{
		...
		foreach ($resultSet as $row) {
			$entry = new Default_Model_AppProgLang();
