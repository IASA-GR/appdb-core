...
class Default_Model_NewsMapperBase
{
	protected $_dbTable;
	...
	public function delete(Default_Model_New $value)
	{
		$q1 = 'id = ?';
		$q2 = $value->id;
		$s=$this->getDbTable()->getAdapter()->quoteInto($q1,$q2);
	...
	public function find($id, Default_Model_News &$value)
	{
