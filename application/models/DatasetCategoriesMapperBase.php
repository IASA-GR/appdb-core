...
class Default_Model_DatasetCategoriesMapperBase
{
	protected $_dbTable;
	...
	public function getDbTable()
	{
		if (null === $this->_dbTable) {
			$this->setDbTable('Default_Model_DbTable_DatasetCategories');
		}
		return $this->_dbTable;
	}

	public function save(Default_Model_DatasetCategory $value)
	{
		global $application;
		$data = array();
	...
	public function delete(Default_Model_DatasetCategory $value)
	{
		$q1 = '';
		$q2 = '';
		$s=$this->getDbTable()->getAdapter()->quoteInto($q1,$q2);
	...
	public function find($id, Default_Model_DatasetCategories &$value)
	{
	...
	public function fetchAll($filter = null, $format = '')
	{
		...
		foreach ($resultSet as $row) {
			$entry = new Default_Model_DatasetCategory();
