...
?>
<?php
class Default_Model_UserAccountStateBase
{
	protected $_mapper;
	protected $_id;
	protected $_name;
	...
	public function __set($name,$value)
	{
		...
		if (('mapper' == $name) || !method_exists($this, $method)) {
			throw new Exception("Invalid UserAccountState property: '$name'");
		}
		if ( is_string($value) ) {
	...
	public function getMapper()
	{
		if (null === $this->_mapper) {
			$this->setMapper(new Default_Model_UserAccountStatesMapper());
		}
		return $this->_mapper;
	}
