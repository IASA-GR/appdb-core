...
class Default_Model_AppOSesMapperBase
{
	protected $_dbTable;
	...
	public function getDbTable()
	{
		if (null === $this->_dbTable) {
			$this->setDbTable('Default_Model_DbTable_AppOSes');
		}
		return $this->_dbTable;
	}

	public function save(Default_Model_AppOSe $value)
	{
		global $application;
		$data = array();
		...
		$q1 = array('appid = ?', 'osid = ?');
		$q2 = array($value->appid, $value->osid);
	...
	public function delete(Default_Model_AppOS $value)
	{
		$q1 = array('appid = ?', 'osid = ?');
		$q2 = array($value->appid, $value->osid);
		$s = array();
	...
	public function find($id, Default_Model_AppOSes &$value)
	{
	...
	{
		$select = $this->getDbTable()->select();
		$select->from($this->getDbTable(),array('COUNT(DISTINCT (appid, osid)) AS count'));
