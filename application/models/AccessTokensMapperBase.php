...
class Default_Model_AccessTokensMapperBase
{
	protected $_dbTable;
	...
	public function getDbTable()
	{
		if (null === $this->_dbTable) {
			$this->setDbTable('Default_Model_DbTable_AccessTokens');
		}
	...
	public function save(Default_Model_AccessToken $value)
	{
		...
		if ( ! isnull($value->getActorid()) ) $data['actor'] = $value->getActorid();
		if ( ! isnull($value->getCreatedOn()) ) $data['createdon'] = $value->getCreatedOn();
		if ( ! isnull($value->getType()) ) $data['type'] = $value->getType();
	...
	public function delete(Default_Model_AccessToken $value)
	{
		$q1 = 'id = ?';
		$q2 = $value->id;
		$s=$this->getDbTable()->getAdapter()->quoteInto($q1,$q2);
	...
	public function fetchAll($filter = null, $format = '')
	{
		...
		foreach ($resultSet as $row) {
			$entry = new Default_Model_AccessToken();
