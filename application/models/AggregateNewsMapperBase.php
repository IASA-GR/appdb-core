...
class Default_Model_AggregateNewsMapperBase
{
	protected $_dbTable;
	...
	public function getDbTable()
	{
		if (null === $this->_dbTable) {
			$this->setDbTable('Default_Model_DbTable_AggregateNews');
		}
		return $this->_dbTable;
	}

	public function save(Default_Model_AggregateNew $value)
	{
		global $application;
		$data = array();
	...
	public function delete(Default_Model_AggregateNewsEntry $value)
	{
		$q1 = '';
		$q2 = '';
		$s=$this->getDbTable()->getAdapter()->quoteInto($q1,$q2);
	...
	public function find($id, Default_Model_AggregateNews &$value)
	{
