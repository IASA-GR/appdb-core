...
class Default_Model_PplDelInfosMapperBase
{
	protected $_dbTable;
	...
	public function getDbTable()
	{
		if (null === $this->_dbTable) {
			$this->setDbTable('Default_Model_DbTable_PplDelInfos');
		}
		return $this->_dbTable;
	}

	public function save(Default_Model_PplDelInfo $value)
	{
		global $application;
		$data = array();
		...
		if ( ! isnull($value->getRoleID()) ) $data['roleid'] = $value->getRoleID();
	...
	public function delete(Default_Model_PplDelInfo $value)
	{
		$q1 = 'id = ?';
		$q2 = $value->id;
		$s=$this->getDbTable()->getAdapter()->quoteInto($q1,$q2);
	...
	public function populate(&$entry,$row)
	{
		...
		$entry->setRoleID($row->roleid);
	}

	public function find($id, Default_Model_PplDelInfos &$value)
	{
	...
	public function fetchAll($filter = null, $format = '')
	{
		...
		foreach ($resultSet as $row) {
			$entry = new Default_Model_PplDelInfo();
