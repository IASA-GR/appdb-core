...
class Default_Model_AppContactVOsMapperBase
{
	protected $_dbTable;
	...
	public function getDbTable()
	{
		if (null === $this->_dbTable) {
			$this->setDbTable('Default_Model_DbTable_AppContactVOs');
		}
		return $this->_dbTable;
	}

	public function save(Default_Model_AppContactVO $value)
	{
		global $application;
		$data = array();
		...
		$q1 = array('appid = ?', 'researcherid = ?', 'void = ?');
		$q2 = array($value->appid, $value->researcherid, $value->void);
	...
	public function delete(Default_Model_AppContactVO $value)
	{
		$q1 = array('appid = ?', 'researcherid = ?', 'void = ?');
		$q2 = array($value->appid, $value->researcherid, $value->void);
		$s = array();
	...
	public function find($id, Default_Model_AppContactVOs &$value)
	{
	...
	{
		$select = $this->getDbTable()->select();
		$select->from($this->getDbTable(),array('COUNT(DISTINCT (appid, researcherid, void)) AS count'));
	...
	public function fetchAll($filter = null, $format = '')
	{
		...
		foreach ($resultSet as $row) {
			$entry = new Default_Model_AppContactVO();
