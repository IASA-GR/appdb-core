...
class Default_Model_PermissionsMapperBase
{
	protected $_dbTable;
	...
	public function getDbTable()
	{
		if (null === $this->_dbTable) {
			$this->setDbTable('Default_Model_DbTable_Permissions');
		}
	...
	public function save(Default_Model_Permission $value)
	{
		...
		if ( ! isnull($value->getTargetGUID()) ) $data['object'] = $value->getTargetGUID();
	...
	public function delete(Default_Model_Permission $value)
	{
		$q1 = '';
		$q2 = '';
		$s=$this->getDbTable()->getAdapter()->quoteInto($q1,$q2);
	...
	public function find($id, Default_Model_Permissions &$value)
	{
