...
class Default_Model_ContextScriptsMapperBase
{
	protected $_dbTable;
	...
	public function getDbTable()
	{
		if (null === $this->_dbTable) {
			$this->setDbTable('Default_Model_DbTable_ContextScripts');
		}
	...
	public function save(Default_Model_ContextScript $value)
	{
		...
		if ( ! isnull($value->getFormatID()) ) $data['formatid'] = $value->getFormatID();
	...
	public function delete(Default_Model_ContextScript $value)
	{
		$q1 = 'id = ?';
		$q2 = $value->id;
		$s=$this->getDbTable()->getAdapter()->quoteInto($q1,$q2);
	...
	public function populate(&$entry,$row)
	{
		...
		$entry->setFormatID($row->formatid);
	...
	public function find($id, Default_Model_ContextScripts &$value)
	{
	...
	public function fetchAll($filter = null, $format = '')
	{
		...
		foreach ($resultSet as $row) {
			$entry = new Default_Model_ContextScript();
