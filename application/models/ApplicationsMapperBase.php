...
class Default_Model_ApplicationsMapperBase
{
	protected $_dbTable;
	...
	public function getDbTable()
	{
		if (null === $this->_dbTable) {
			$this->setDbTable('Default_Model_DbTable_Applications');
		}
...
//		if ( ! isnull($value->getKeywords()) ) $data['keywords'] = $value->getKeywords();
		...
		if ( ! isnull($value->getRatingCount()) ) $data['ratingcount'] = $value->getRatingCount();
	...
	public function delete(Default_Model_Application $value)
	{
		$q1 = 'id = ?';
		$q2 = $value->id;
		$s=$this->getDbTable()->getAdapter()->quoteInto($q1,$q2);
