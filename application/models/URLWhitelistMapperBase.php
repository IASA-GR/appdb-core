...
class Default_Model_URLWhitelistMapperBase
{
	protected $_dbTable;
	...
	public function getDbTable()
	{
		if (null === $this->_dbTable) {
			$this->setDbTable('Default_Model_DbTable_URLWhitelist');
		}
		return $this->_dbTable;
	}

	public function save(Default_Model_URLWhitelist $value)
	{
		global $application;
		$data = array();
		if ( ! isnull($value->getId()) ) $data['id'] = $value->getId();
		if ( ! isnull($value->getUrl()) ) $data['url'] = $value->getUrl();
		if ( ! isnull($value->getSince()) ) $data['since'] = $value->getSince();
	...
	public function delete(Default_Model_URLWhitelistEntry $value)
	{
		$q1 = '';
		$q2 = '';
		$s=$this->getDbTable()->getAdapter()->quoteInto($q1,$q2);
	...
	public function populate(&$entry,$row)
	{
		...
		$entry->setSince($row->since);
	}

	public function find($id, Default_Model_URLWhitelist &$value)
	{
	...
	public function fetchAll($filter = null, $format = '')
	{
		...
		foreach ($resultSet as $row) {
			$entry = new Default_Model_URLWhitelistEntry();
