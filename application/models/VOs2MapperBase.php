...
class Default_Model_VOs2MapperBase
{
	protected $_dbTable;
	...
	public function getDbTable()
	{
	    if (null === $this->_dbTable) {
	        $this->setDbTable('Default_Model_DbTable_VOs2');
	    }
	    return $this->_dbTable;
	}

	public function save(Default_Model_VOs2 $value)
	{
	    global $application;
	    $data = array(
	...
	public function delete(Default_Model_VOs2 $value)
	{
		$q1 = 'id = ?' ;
		$q2 = $value->id;
		if ( is_array($q1) ) {
	...
	public function find($id, Default_Model_VOs2 &$value)
	{
