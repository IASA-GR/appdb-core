...
?>
<?php
class Default_Model_AppTagBase
{
	protected $_mapper;
	protected $_id;
	protected $_appID;
	...
	public function __set($name,$value)
	{
		...
		if (('mapper' == $name) || !method_exists($this, $method)) {
			throw new Exception("Invalid AppTag property: '$name'");
		}
		if ( is_string($value) ) {
	...
	public function getMapper()
	{
		if (null === $this->_mapper) {
			$this->setMapper(new Default_Model_AppTagsMapper());
		}
		return $this->_mapper;
	}
	...
	public function toXML($recursive=false)
	{
		...
		if ($this->_tag !== null) $XML .= "<tag>".recode_string("utf8..xml",$this->_tag)."</tag>\n";
		$XML .= "</AppTag>\n";
		return $XML;
	}
}
