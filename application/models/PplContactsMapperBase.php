...
class Default_Model_PplContactsMapperBase
{
	protected $_dbTable;
	...
	public function getDbTable()
	{
		if (null === $this->_dbTable) {
			$this->setDbTable('Default_Model_DbTable_PplContacts');
		}
		return $this->_dbTable;
	}

	public function save(Default_Model_PplContact $value)
	{
		global $application;
		$data = array();
		if ( ! isnull($value->getId()) ) $data['id'] = $value->getId();
		if ( ! isnull($value->getContactData()) ) $data['contactdata'] = $value->getContactData();
	...
	public function delete(Default_Model_PplContact $value)
	{
		$q1 = '';
		$q2 = '';
		$s=$this->getDbTable()->getAdapter()->quoteInto($q1,$q2);
	...
	{
		$entry->setId($row->id);
		$entry->setContactData($row->contactdata);
	}

	public function find($id, Default_Model_PplContacts &$value)
	{
	...
	public function fetchAll($filter = null, $format = '')
	{
		...
		foreach ($resultSet as $row) {
			$entry = new Default_Model_PplContact();
