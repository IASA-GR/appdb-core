...
class Default_Model_OrganizationsMapperBase
{
	protected $_dbTable;
	...
	public function getDbTable()
	{
		if (null === $this->_dbTable) {
			$this->setDbTable('Default_Model_DbTable_Organizations');
		}
	...
	public function save(Default_Model_Organization $value)
	{
		...
		if ( ! isnull($value->getDeletedByID()) ) $data['deletedby'] = $value->getDeletedByID();
	...
	public function delete(Default_Model_Organization $value)
	{
		$q1 = 'id = ?';
		$q2 = $value->id;
		$s=$this->getDbTable()->getAdapter()->quoteInto($q1,$q2);
	...
	public function fetchAll($filter = null, $format = '')
	{
		...
		foreach ($resultSet as $row) {
			$entry = new Default_Model_Organization();
