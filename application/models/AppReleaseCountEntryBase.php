...
?>
<?php
class Default_Model_AppReleaseCountEntryBase
{
	protected $_mapper;
	protected $_appID;
	...
	public function __set($name,$value)
	{
		...
		if (('mapper' == $name) || !method_exists($this, $method)) {
			throw new Exception("Invalid AppReleaseCountEntry property: '$name'");
		}
		if ( is_string($value) ) {
	...
	public function setRelCount($value)
	{
		/* if ( $value === null ) {
			$this->_relCount = 'NULL';
		} else */ $this->_relCount = $value;
		return $this;
	}
	...
	public function getMapper()
	{
		if (null === $this->_mapper) {
			$this->setMapper(new Default_Model_AppReleaseCountMapper());
		}
		return $this->_mapper;
	}
	...
	public function toXML($recursive=false)
	{
		...
		if ($this->_relCount !== null) $XML .= "<relCount>".$this->_relCount."</relCount>\n";
		$XML .= "</AppReleaseCountEntry>\n";
		return $XML;
	}
}
