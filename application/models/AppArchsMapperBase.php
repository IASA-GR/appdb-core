...
class Default_Model_AppArchsMapperBase
{
	protected $_dbTable;
	...
	public function getDbTable()
	{
		if (null === $this->_dbTable) {
			$this->setDbTable('Default_Model_DbTable_AppArchs');
		}
		return $this->_dbTable;
	}

	public function save(Default_Model_AppArch $value)
	{
		global $application;
		$data = array();
		...
		$q1 = array('appid = ?', 'archid = ?');
		$q2 = array($value->appid, $value->archid);
	...
	public function delete(Default_Model_AppArch $value)
	{
		$q1 = array('appid = ?', 'archid = ?');
		$q2 = array($value->appid, $value->archid);
		$s = array();
	...
	public function find($id, Default_Model_AppArchs &$value)
	{
	...
	{
		$select = $this->getDbTable()->select();
		$select->from($this->getDbTable(),array('COUNT(DISTINCT (appid, archid)) AS count'));
	...
	public function fetchAll($filter = null, $format = '')
	{
		...
		foreach ($resultSet as $row) {
			$entry = new Default_Model_AppArch();
