...
class Default_Model_ContextsMapperBase
{
	protected $_dbTable;
	...
	public function getDbTable()
	{
		if (null === $this->_dbTable) {
			$this->setDbTable('Default_Model_DbTable_Contexts');
		}
	...
	public function save(Default_Model_Context $value)
	{
		...
		if ( ! isnull($value->getApplicationID()) ) $data['appid'] = $value->getApplicationID();
	...
	public function delete(Default_Model_Context $value)
	{
		$q1 = 'id = ?';
		$q2 = $value->id;
		$s=$this->getDbTable()->getAdapter()->quoteInto($q1,$q2);
	...
	{
		$entry->setId($row->id);
		$entry->setApplicationID($row->appid);
	...
	public function find($id, Default_Model_Contexts &$value)
	{
	...
	public function fetchAll($filter = null, $format = '')
	{
		...
		foreach ($resultSet as $row) {
			$entry = new Default_Model_Context();
