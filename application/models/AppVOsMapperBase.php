...
class Default_Model_AppVOsMapperBase
{
	protected $_dbTable;
	...
	public function getDbTable()
	{
		if (null === $this->_dbTable) {
			$this->setDbTable('Default_Model_DbTable_AppVOs');
		}
	...
	public function find($id, Default_Model_AppVOs &$value)
	{
	...
	{
		$select = $this->getDbTable()->select();
		$select->from($this->getDbTable(),array('COUNT(DISTINCT (void, appid)) AS count'));
