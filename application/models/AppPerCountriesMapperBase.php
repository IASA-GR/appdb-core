...
class Default_Model_AppPerCountriesMapperBase
{
	protected $_dbTable;
	...
	public function getDbTable()
	{
		if (null === $this->_dbTable) {
			$this->setDbTable('Default_Model_DbTable_AppPerCountries');
		}
		return $this->_dbTable;
	}

	public function save(Default_Model_AppPerCountry $value)
	{
		global $application;
		$data = array();
		...
		if ( ! isnull($value->getSum()) ) $data['sum'] = $value->getSum();
	...
	public function delete(Default_Model_AppPerCountry $value)
	{
		$q1 = '';
		$q2 = '';
		$s=$this->getDbTable()->getAdapter()->quoteInto($q1,$q2);
	...
	public function populate(&$entry,$row)
	{
		...
		$entry->setSum($row->sum);
	}

	public function find($id, Default_Model_AppPerCountries &$value)
	{
	...
	public function fetchAll($filter = null, $format = '')
	{
		...
		foreach ($resultSet as $row) {
			$entry = new Default_Model_AppPerCountry();
