...
INSERT INTO version (major,minor,revision,notes) 
	SELECT 8, 13, 3, E'Functional XML support for researcher app/vo reports'
	WHERE NOT EXISTS (SELECT * FROM version WHERE major=8 AND minor=13 AND revision=3);
