...
INSERT INTO version (major,minor,revision,notes) 
	SELECT 8, 13, 12, E'Fix application ordering in app_to_xml_list'
	WHERE NOT EXISTS (SELECT * FROM version WHERE major=8 AND minor=13 AND revision=12);
