...
CREATE OR REPLACE FUNCTION public.oai_datacite_xslt(x xml)
 RETURNS xml
 LANGUAGE xslt
AS $function$
...
INSERT INTO version (major,minor,revision,notes) 
	SELECT 8, 18, 10, E'Modify OAI-Datacite XSLT to properly support VAs'
	WHERE NOT EXISTS (SELECT * FROM version WHERE major=8 AND minor=18 AND revision=10);
