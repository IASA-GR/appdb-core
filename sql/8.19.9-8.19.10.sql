...
INSERT INTO version (major,minor,revision,notes) 
	SELECT 8, 19, 10, E'Fix typo in trigger function trfn_vapp_versions_pidhandle'
	WHERE NOT EXISTS (SELECT * FROM version WHERE major=8 AND minor=19 AND revision=10);
