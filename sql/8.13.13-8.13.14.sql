...
INSERT INTO version (major,minor,revision,notes) 
	SELECT 8, 13, 14, E'Minor modifications to app_vo_stats_to_xml function'
	WHERE NOT EXISTS (SELECT * FROM version WHERE major=8 AND minor=13 AND revision=14);
