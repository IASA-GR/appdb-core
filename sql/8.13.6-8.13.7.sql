...
$BODY$
  ...
  COST 100
  ROWS 1000;
ALTER FUNCTION public.vapp_image_providers_to_xml(integer)
  OWNER TO appdb;

INSERT INTO version (major,minor,revision,notes) 
	SELECT 8, 13, 7, E'Do not filter out images based on good VMI instance id in vapp_image_providers_to_xml function'
	WHERE NOT EXISTS (SELECT * FROM version WHERE major=8 AND minor=13 AND revision=7);
