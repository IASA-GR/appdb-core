...
-- Function: public.app_to_xml_ext(integer, integer)

-- DROP FUNCTION public.app_to_xml_ext(integer, integer);
...
INSERT INTO version (major,minor,revision,notes) 
	SELECT 8, 17, 10, E'Add continuous delivery information in app_to_xml_ext function'
	WHERE NOT EXISTS (SELECT * FROM version WHERE major=8 AND minor=17 AND revision=10);
