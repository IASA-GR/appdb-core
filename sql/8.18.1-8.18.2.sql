...
DELETE FROM config WHERE var IN ('datacite_xslt', 'oaidc_xslt', 'oaidatacite_xslt');

INSERT INTO version (major,minor,revision,notes) 
	SELECT 8, 18, 2, E'Create plxslt OAI-PMH XSLT functions'
	WHERE NOT EXISTS (SELECT * FROM version WHERE major=8 AND minor=18 AND revision=2);
