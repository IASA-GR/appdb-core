...
UPDATE cache.appxmlcache SET oaidatacitexml = NULL;

INSERT INTO version (major,minor,revision,notes) 
	SELECT 8, 19, 13, E'Remove extra double quotes in resourceType element of oai_datacite_xslt function'
	WHERE NOT EXISTS (SELECT * FROM version WHERE major=8 AND minor=19 AND revision=13);
