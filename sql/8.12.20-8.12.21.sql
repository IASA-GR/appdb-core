...
INSERT INTO version (major,minor,revision,notes) 
	SELECT 8, 12, 21, E'Fix for extended VA provider to XML function (image cardinality)'
	WHERE NOT EXISTS (SELECT * FROM version WHERE major=8 AND minor=12 AND revision=21);
