...
INSERT INTO version (major,minor,revision,notes)
        SELECT 8, 22, 5, E'Fix erroneous attribute xpaths in consume_app function'
        WHERE NOT EXISTS (SELECT * FROM version WHERE major=8 AND minor=22 AND revision=5);
